...
In the Pybank folder the script in the Pybank processes data from a csv file (budget_.csv) and analyses according to the instruction. The output is sent to the terminal screen. 
