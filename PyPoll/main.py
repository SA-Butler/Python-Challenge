...
#csvpath = os.path.join('c:/Users/simon/Documents/Data Bootcamp/Git Repo Clones/UBHM-VIRT-DATA-PT-10-2022-U-LOLC/Python-Challenge/PyPoll/Resources','election_data.csv')
...
#print('Total Data Records (excl Headers)', count)  # note add 1 to count if the file doesnt have headers
...
with open (csvpath, "r") as csv_file:
    ...
    next(csv_reader)#ignores the headers
...
row1 = str(candidate1) , str(votescan1)
row2 = str(candidate2) , str(votescan2)
row3 = str(candidate3) , str(votescan3)
...
data_output = os.path.join('c:/Users/simon/Documents/Data Bootcamp/Git Repo Clones/UBHM-VIRT-DATA-PT-10-2022-U-LOLC/Python-Challenge/PyPoll/Analysis', "results.csv")
